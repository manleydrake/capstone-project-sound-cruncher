...
nb_epochs	= 100 # number of epochs, should be high, the end of the learning process is controled by early stoping
es_patience	= 100 # patience for early stoping 
batchSize	= 256 # batch size for mini-batch training
hdf5path	= '../birdclef_data/data_top10_nozero.hdf5' # training data generated by loadData.py
modelPath	= './model-BirdClef.py' # filename of the model to use (currently model-birdClef.py or model-AlexNet.py)
logfileName	= 'log.xls'
...
if (tensorflowBackend):
	...
	#config.gpu_options.allow_growth=True commented out b/c not using GPU
...
testSplit	= 0.01 # was 1%
validationSplit	= 0.05 # was 5%
f.close()
# load training data
...
earlyStopping	= EarlyStopping(monitor='val_loss', patience = es_patience) # early stopping
