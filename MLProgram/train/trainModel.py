...
nb_epochs	= 5 # number of epochs, should be high, the end of the learning process is controled by early stoping
es_patience	= 100 # patience for early stoping 
batchSize	= 1350 # batch size for mini-batch training
hdf5path	= '../birdclef_data/data_top16_nozero.hdf5' # training data generated by loadData.py
...
testSplit	= 0.20 # 20% was 1%
validationSplit	= 0.25 # 25% was 5%
f.close()
# load training data
